 ...
 *
 * Disassembly of ssdt.aml, Mon Jan 24 18:22:53 2022
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000F2B (3883)
 *     Revision         0x01
 *     Checksum         0x00
 *     OEM ID           "NOKIA "
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                ...
                If ((Arg0 == ToUUID ("a2e7f6c4-9638-4485-9f12-6b4e20b60d63") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == 0x03))
                    {
                        ...
                        Return (Buffer (0x03AE)
                        {
                            /* 0000 */  0x4D, 0x61, 0x6B, 0x65, 0x70, 0x65, 0x61, 0x63,  // Makepeac
                            /* 0008 */  0x65, 0x00, 0x00, 0x20, 0x08, 0x01, 0x22, 0x00,  // e.. ..".
                            /* 0010 */  0x02, 0x01, 0x01, 0x03, 0x01, 0x11, 0x04, 0x01,  // ........
                            /* 0018 */  0x01, 0x06, 0x01, 0x01, 0x08, 0x01, 0x01, 0x0E,  // ........
                            /* 0020 */  0x01, 0x01, 0x40, 0x01, 0x01, 0x41, 0x01, 0x04,  // ..@..A..
                            ...
                            /* 03A0 */  0x0C, 0x48, 0x19, 0x0D, 0x04, 0x06, 0x03, 0x00,  // .H......
                            /* 03A8 */  0x6F, 0x0D, 0x03, 0x00, 0x40, 0x04               // o...@.
                        })
                    }
                }
            }
